      ...
      <section className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-xl shadow-md p-6 md:p-8 space-y-6">
          <div>
            ...
            <p className="text-slate-700 leading-relaxed">The information provided by StateOvertime.com ("we," "us," or "our") on this website is for general informational purposes only. All information on the website is provided in good faith, however we make no representation or warranty of any kind, express or implied, regarding the accuracy, adequacy, validity, reliability, availability, or completeness of any information on the website.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">No Legal or Financial Advice</h2>
            <p className="text-slate-700 leading-relaxed">The overtime calculator and any related content on this website does not constitute legal, financial, or professional advice. The calculations provided are estimates based on federal FLSA rules and state-specific overtime laws as we understand them. Actual overtime pay may vary based on your specific employment situation, exemptions, contracts, and other factors.</p>
            <p className="text-slate-700 leading-relaxed mt-3">You should consult with a qualified employment attorney, your HR department, or your state labor board for advice specific to your situation.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Limitation of Liability</h2>
            <p className="text-slate-700 leading-relaxed">Under no circumstance shall we have any liability to you for any loss or damage of any kind incurred as a result of the use of the website or reliance on any information provided on the website. Your use of the website and your reliance on any information on the website is solely at your own risk.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">External Links</h2>
            <p className="text-slate-700 leading-relaxed">The website may contain links to other websites or content belonging to or originating from third parties. Such external links are not investigated, monitored, or checked for accuracy, adequacy, validity, reliability, availability, or completeness by us.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Changes to This Disclaimer</h2>
            <p className="text-slate-700 leading-relaxed">We reserve the right to modify this disclaimer at any time. Changes take effect immediately upon posting to the website.</p>
          </div>

          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-2">Contact Us</h2>
            <p className="text-slate-700 leading-relaxed">If you have questions about this Disclaimer, please contact us at: <a href="mailto:contact@stateovertime.com" className="text-blue-600 hover:underline font-semibold">contact@stateovertime.com</a></p>
          </div>
